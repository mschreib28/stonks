...
## 1. Non-Commercial Use (CC BY-NC 4.0)
...
For commercial use, a separate proprietary license is required. Commercial use includes, but is not limited to:
...
- Use in SaaS (Software as a Service) offerings
- Use in commercial applications or platforms
...
- Custom licensing terms for enterprise use

## License Comparison

| Feature | CC BY-NC 4.0 | Commercial License |
|---------|---------------|-------------------|
| Non-commercial use | ✅ Allowed | ✅ Allowed |
| Commercial use | ❌ Not allowed | ✅ Allowed |
| Modification | ✅ Allowed | ✅ Allowed (terms may vary) |
| Distribution | ✅ Allowed (non-commercial) | ✅ Allowed (terms may vary) |
| Attribution required | ✅ Yes | ✅ Yes |
| Cost | Free | Paid (contact for pricing) |

## Questions?

If you're unsure whether your use case qualifies as commercial or non-commercial, please contact the licensor for clarification.

---

**Note:** This dual-licensing model allows the software to be freely available for non-commercial use while providing a path for commercial entities to use the software legally and support its continued development.
